...
export { default as CancelSquareIcon } from './cancel-square-icon';
...
export { default as DotIconV3 } from './dot-icon-v3';
...
export { default as EnrollmentIcon } from './enrollment-icon';
...
export { default as FileMarkIcon } from './file-mark-icon';
...
export { default as ProgramIcon } from './program-icon';
